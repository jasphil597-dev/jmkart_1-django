...
#         status=body["status"],
#     )
#     # print("DEBUG payments(): payment created with id =", payment.payment_id)
...
#     # 7. Send order received email to customer
#     to_email = order.email or request.user.email
#     print("DEBUG payments(): to_email =", to_email)
...
#         print(
#             "DEBUG payments(): order email sent_count =",
#             sent_count,
#             "to:",
#             [to_email],
#         )

#         # 8. Return JSON back to JS
#         data = {
